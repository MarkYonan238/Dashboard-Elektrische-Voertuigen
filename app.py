...
if rad == 'Soorten Voertuigen':
    ...
    'In deze grafiek is voor elke brandstof categorie een lijn te zien. Deze geeft de groei aan van de verkochte voertuigen (over de afgelopen vier jaar) op een logaritmische schaalverdeling.'
    ##############################################################################################################
